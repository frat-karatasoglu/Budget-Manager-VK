...
<img width="1919" height="969" alt="image" src="https://github.com/user-attachments/assets/7fb6389c-130f-42c3-870c-594312feaebb" />
<img width="1919" height="969" alt="image" src="https://github.com/user-attachments/assets/e5fee767-8565-40b9-8710-5b07f8ba9611" />

> 💡 **Примечание:** Этот проект работает как с `yarn`, так и с `npm`. Если вы используете `npm`, замените все `yarn` команды на их эквиваленты:  
